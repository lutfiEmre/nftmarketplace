  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start">
        <div className={'w-full h-screen relative'}>
            <div className={'xl:px-[100px] border-b-[1px] border-[#EFEFEF] px-[100px] lg:px-[50px] 2xl:px-[120px] py-[39px]  justify-between w-full flex flex-row'}>
                ...
                <svg  onClick={() => {setMenu(prevState => !prevState)}}  className={'w-[50px] cursor-pointer cursor-pointer lg:hidden flex h-[50px]'} xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
                    <path d="M4 6H20M4 12H20M4 18H20" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
          <div className={`${menu  ? '!right-0' : 'right-[-500px]'} lg:!right-[-500px] flex flex-col gap-[50px] pt-[50px] transition-all duration-300 ease-in absolute top-0 flex items-center flex-col pt[50px] right-[-500px] z-20 bg-white shadow-2xl w-[350px] h-full`}>
